 ...
 */
public class SubscriberSearchIncorrectResultSizeException extends SubscriberDomainException {
     ...
     */
    public SubscriberSearchIncorrectResultSizeException(String message, String details) {
        super(message, details);
    }

    public SubscriberSearchIncorrectResultSizeException(String message, Throwable cause, String details) {
